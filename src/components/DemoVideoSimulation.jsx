      ...
      <div className="flex-1 p-6 flex flex-col justify-end">
        {!isComplete ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center animate-[fadeIn_0.5s_ease-out]">
            ...
            <button onClick={onViewReport} className="bg-teal-base text-[#051511] font-bold px-6 py-2.5 rounded-lg hover:bg-teal-light transition-colors font-sans cursor-pointer">
              View PDF Report
            </button>
          </div>
        )}

...
export default function TekkiBlazePartners() {
 ...
 <a href="#register" className="bg-amber text-ink py-2 font-bold text-[13px] px-[18px] rounded-xl shadow-[0_6px_18px_rgba(239,159,39,0.25)] hover:-translate-y-0.5 hover:shadow-[0_10px_24px_rgba(239,159,39,0.4)] transition-all">Become a Partner →</a>
 </div>
 </div>
 </nav>
 ...
 <h1 className="font-inter font-[800] tracking-tight text-[30px] md:text-[42px] leading-[1.06]">
 ...
 <div className="text-[12px] text-text-soft font-medium mt-0.5 max-w-[180px] leading-tight">The global electronics repair economy</div>
 </div>
 ...
 <div className="text-[12px] text-text-soft font-medium mt-0.5 max-w-[180px] leading-tight">Refurbished computer &amp; laptop market growth</div>
 </div>
 <div className="w-[1px] bg-hairline my-3 min-[721px]:block hidden" />
 <div className="p-[14px_28px] max-[720px]:p-[10px_16px] text-center">
 <div className="font-inter font-black text-2xl tracking-tight text-teal-mid">0 tools</div>
 <div className="text-[12px] text-text-soft font-medium mt-0.5 max-w-[180px] leading-tight">that scan, certify &amp; verify a PC in one product — until now</div>
 </div>
 </div>
 ...
 <div className="text-center text-[14px] text-text-soft font-light mb-[22px] max-w-[620px] mx-auto">The same two suites, three different productivity stories — this is where the "income" in <i>turn diagnostics into income</i> actually comes from.</div>
 ...
 <div className="relative z-10 text-[12px] tracking-[3px] uppercase font-extrabold text-teal-light mb-2.5">Repair shops &amp; technicians</div>
 ...
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">One 3-minute scan</b> replaces five separate diagnostic tools</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">More jobs per day</b> — investigation time becomes repair time</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Every repair certified</b> — a verifiable record, not a verbal assurance</span></li>
 </ul>
 ...
 <div className="bg-gradient-to-br from-[#063a30] to-[#04231d] border border-amber/[0.22] rounded-2xl p-6 pb-5 text-white relative overflow-hidden flex flex-col">
 <div className="absolute -top-[90px] -right-[70px] w-[220px] h-[220px] rounded-full bg-[radial-gradient(circle,rgba(239,159,39,0.15)_0%,transparent_65%)]" />
 <div className="relative z-10 text-[12px] tracking-[3px] uppercase font-extrabold text-teal-light mb-2.5">System Integrators &amp; MSPs</div>
 ...
 <ul className="relative z-10 list-none flex-1 flex flex-col gap-2 mb-4">
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Fleet-wide A–F grades</b> — every managed machine scored in minutes</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Downtime prevented</b> — SSD wear, thermals &amp; patch posture caught early</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Faster fleets</b> — standardised optimization across hundreds of machines</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Verifiable reports</b> — client reviews built on facts, not debates</span></li>
 </ul>
 <div className="relative z-10 inline-flex items-center gap-2 bg-white/[0.07] border border-teal-light/30 rounded-xl p-[9px_13px] text-xs font-bold text-white w-fit">
 ...
 <div className="bg-gradient-to-br from-[#063a30] to-[#04231d] border border-amber/[0.22] rounded-2xl p-6 pb-5 text-white relative overflow-hidden flex flex-col">
 <div className="absolute -top-[90px] -right-[70px] w-[220px] h-[220px] rounded-full bg-[radial-gradient(circle,rgba(239,159,39,0.15)_0%,transparent_65%)]" />
 <div className="relative z-10 text-[12px] tracking-[3px] uppercase font-extrabold text-teal-light mb-2.5">Refurbishers &amp; rental fleets</div>
 ...
 <ul className="relative z-10 list-none flex-1 flex flex-col gap-2 mb-4">
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Graded by measurement</b>, not visual inspection — every unit, every batch</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Evidence-based pricing</b> — an A sells as an A, nothing under-sold</span></li>
 <li className="flex gap-2.5 items-start text-[13px] text-[#CFE9DD] font-light leading-snug"><CheckCircle /><span><b className="text-white font-bold">Hardware Security Lock</b> — every component on record from dispatch to return, disputes settled instantly</span></li>
 </ul>
 <div className="relative z-10 inline-flex items-center gap-2 bg-white/[0.07] border border-teal-light/30 rounded-xl p-[9px_13px] text-xs font-bold text-white w-fit">
 ...
 <div className="text-center text-[14px] text-text-soft font-light mb-[22px] max-w-[620px] mx-auto">Four outcomes, one platform — each solves a gap the industry has priced in for years.</div>
 ...
 <div className="text-[12px] tracking-[3px] uppercase font-extrabold text-amber-dark mb-1.5">Diagnostics</div>
 ...
 <div className="text-[12px] font-bold text-white">System Health · 51/100</div>
 ...
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-red-900/[0.28] text-[#FF9B86]">KERNEL HANG</span>
 </div>
 ...
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-amber/[0.22] text-amber-light">ACTION REQUIRED</span>
 </div>
 </div>
 </div>
 ...
 {/* Pillar 2 */}
 <div className="bg-white border border-hairline border-t-3 border-t-amber rounded-[14px] p-6 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(4,52,44,0.07)] transition-all">
 <div className="text-[12px] tracking-[3px] uppercase font-extrabold text-amber-dark mb-1.5">Productivity</div>
 ...
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-[rgba(29,158,117,0.25)] text-[#9FE1CB]">CLEARED ✓</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-b border-white/[0.07] text-[#CFE9DD] text-[11px] leading-tight">
 <span>Startup bloat · 11 items</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-[rgba(29,158,117,0.25)] text-[#9FE1CB]">OPTIMIZED ✓</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-none pb-0 text-[#CFE9DD] text-[11px] leading-tight">
 <span>Update backlog · OS &amp; drivers</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-amber/[0.22] text-amber-light">QUEUED</span>
 </div>
 </div>
 </div>
 ...
 {/* Pillar 3 */}
 <div className="bg-white border border-hairline border-t-3 border-t-amber rounded-[14px] p-6 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(4,52,44,0.07)] transition-all">
 <div className="text-[12px] tracking-[3px] uppercase font-extrabold text-amber-dark mb-1.5">Performance</div>
 ...
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-amber/[0.22] text-amber-light">72.1°C · THROTTLING</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-b border-white/[0.07] text-[#CFE9DD] text-[11px] leading-tight">
 <span>Software fit · RAM headroom</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-amber/[0.22] text-amber-light">MINIMUM ONLY</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-none pb-0 text-[#CFE9DD] text-[11px] leading-tight">
 <span>Certificate issued · Scan #B41K</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-[rgba(29,158,117,0.25)] text-[#9FE1CB]">B · VERIFIABLE</span>
 </div>
 </div>
 </div>
 ...
 {/* Pillar 4 */}
 <div className="bg-white border border-hairline border-t-3 border-t-amber rounded-[14px] p-6 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(4,52,44,0.07)] transition-all">
 <div className="text-[12px] tracking-[3px] uppercase font-extrabold text-amber-dark mb-1.5">Hardware Security</div>
 ...
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-[rgba(29,158,117,0.25)] text-[#9FE1CB]">LOCKED 🔒</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-b border-white/[0.07] text-[#CFE9DD] text-[11px] leading-tight">
 <span>Re-scan after service · signatures compared</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-[rgba(29,158,117,0.25)] text-[#9FE1CB]">MATCH ✓</span>
 </div>
 <div className="flex justify-between items-center gap-2 py-1.5 border-none pb-0 text-[#CFE9DD] text-[11px] leading-tight">
 <span>Storage differs from record · owner informed</span>
 <span className="text-[9px] font-extrabold tracking-[0.4px] p-[2px_8px] rounded-[10px] whitespace-nowrap shrink-0 bg-amber/[0.22] text-amber-light">CHANGE NOTICED</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="text-center text-[14px] text-text-soft font-light mb-[22px] max-w-[620px] mx-auto">Voices from our pilot validation program, underway ahead of public launch.</div>
 ...
 <div className="text-[11px] tracking-[1.2px] uppercase font-extrabold text-teal-mid mb-3">{v.label}</div>
 <div className="font-playfair italic text-[14px] text-ink leading-[1.55] flex-1 mb-3">{v.quote}</div>
 <div className="text-[12px] text-text-soft font-semibold pt-2.5 border-t border-hairline">{v.who}</div>
 </div>
 ))}
 </div>
 <div className="text-center text-[11px] text-text-soft font-light mt-3 tracking-[0.3px]">Pilot program figures — being independently validated ahead of launch.</div>
 </div>
 </section>
 ...
 <div className="font-inter font-extrabold text-[11px] tracking-widest text-amber-dark uppercase mb-1.5">Track {t.trackNum}</div>
 <h3 className="font-inter font-extrabold text-[17px] text-ink mb-1.5 leading-[1.25]">{t.name}</h3>
 <div className="text-[13px] text-teal-mid font-semibold mb-2.5">{t.subtitle}</div>
 <div className="text-[13px] text-text-mid font-light leading-relaxed mb-3">{t.desc}</div>
 <ul className="list-none mb-3.5 flex-1">
 {t.bullets.map((b, bi) => (
 <li key={bi} className="flex gap-2 items-start text-[13px] text-text-mid py-1 font-light leading-relaxed"><CheckSmall />{b}</li>
 ))}
 </ul>
 ...
 <label htmlFor="f_mob" className="block text-[13px] font-bold text-text-mid mb-1.5">Mobile number <span className="text-red-700">*</span></label>
 ...
 <div className="text-[12px] text-text-soft mt-1 font-light">We’ll WhatsApp your partner activation link.</div>
 {errors.mob && <div className="text-[12px] mt-1 text-red-700 font-bold" role="alert">{errors.mob}</div>}
 </div>
 <div className="mb-3.5">
 <label htmlFor="f_email" className="block text-[13px] font-bold text-text-mid mb-1.5">Email <span className="text-red-700">*</span></label>
 ...
 {errors.email && <div className="text-[12px] mt-1 text-red-700 font-bold" role="alert">{errors.email}</div>}
 </div>
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
 <div className="mb-3.5">
 <label htmlFor="f_name" className="block text-[13px] font-bold text-text-mid mb-1.5">Your name <span className="font-medium text-text-soft text-[11px]">(optional)</span></label>
 <input className={inputCls} ref={nameRef} id="f_name" type="text" placeholder="Full name" autoComplete="name" />
 </div>
 <div className="mb-3.5">
 <label htmlFor="f_biz" className="block text-[13px] font-bold text-text-mid mb-1.5">Business name <span className="font-medium text-text-soft text-[11px]">(optional)</span></label>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
 <div className="mb-3.5">
 <label htmlFor="f_gst" className="block text-[13px] font-bold text-text-mid mb-1.5">
 ...
 {errors.gst && <div className="text-[12px] mt-1 text-red-700 font-bold" role="alert">{errors.gst}</div>}
 <div className="text-[12px] text-text-soft mt-1 font-light">
 {current.gst === 'required'
 ...
 <div className="mb-3.5">
 <label htmlFor="f_city" className="block text-[13px] font-bold text-text-mid mb-1.5">City <span className="font-medium text-text-soft text-[11px]">(optional)</span></label>
 <input className={inputCls} ref={cityRef} id="f_city" type="text" placeholder="e.g. Bengaluru" autoComplete="address-level2" />
 <div className="text-[12px] text-text-soft mt-1 font-light">Helps us route nearby leads to you sooner.</div>
 </div>
 </div>

export default function MobileCTA() {
 ...
 <span className="text-[14px] font-black text-ink leading-tight">Tekki Blaze</span>
 <span className="text-[12px] font-medium text-text-soft">2 scans &middot; ₹299</span>
 </div>
 <a
 href="#get"

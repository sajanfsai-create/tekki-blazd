          ...
          <div className="mt-24 max-w-[700px] mx-auto relative">
            ...
            <div className="bg-white rounded-2xl px-6 py-5 sm:px-8 sm:py-6 flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 border border-[rgba(239,159,39,0.5)] shadow-[0_12px_60px_-10px_rgba(239,159,39,0.35)]">
              ...
              <div className="flex-1 text-center sm:text-left mt-0.5">
                <div className="text-[10.5px] tracking-[2.5px] uppercase font-bold text-amber-dark mb-2">Proof, not promises</div>
                <h3 className="font-inter font-black text-[20px] text-ink mb-1.5 tracking-tight">From scan to a shareable A–F report.</h3>
                <p className="text-[13.5px] text-text-soft leading-relaxed mb-5 max-w-[420px] mx-auto sm:mx-0">
                ...
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  <button 
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 rounded-[10px] border border-[rgba(29,158,117,0.25)] text-[#00604b] text-[12.5px] font-bold hover:bg-teal-ghost transition-colors"
                  >
                  ...
                  <button 
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 rounded-[10px] bg-[#0d221c] text-white text-[12.5px] font-bold hover:bg-[#153a2f] transition-colors shadow-[0_4px_12px_rgba(13,34,28,0.15)]"
                  >

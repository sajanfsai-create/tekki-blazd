...
export default function PricingSection() {
 ...
 <h2 className="font-inter font-[800] tracking-tight text-[30px] md:text-[42px] leading-[1.05] text-ink mb-5">
 Two scans.<br /><span className="text-[#0f6e56]">₹299.</span> No subscription.
 </h2>
 <p className="text-[16px] text-text-soft max-w-[680px] mx-auto leading-[1.6]">

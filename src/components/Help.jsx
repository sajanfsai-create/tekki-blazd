...
export default function Help() {
 ...
 <summary className="list-none cursor-pointer p-4.5 font-semibold text-[16px] text-emerald-950 flex items-center justify-between gap-3.5 [&::-webkit-details-marker]:hidden">
 ...
 <div className="px-4.5 pb-5 text-[15px] text-emerald-900/80">
 <p><strong>₹299 for 2 scan credits</strong> (Scan + Re-Scan, plus GST), with no subscription. A <strong>Household Pack (6 credits for ₹699)</strong> is available, along with bulk pricing for repair shops and businesses.</p>
 </div>
 </details>

        ...
        <section ref={sectionRef} id="why" className="py-[44px] bg-off-white border-y border-[rgba(29,158,117,0.14)]">
            <div className="wrap max-w-[1140px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[0.92fr_1.08fr] gap-6 items-stretch">
                            ...
                            return (
                                <Reveal key={tab.id} delay={100 + (idx * 80)}>
                                    <button
                                        ...
                                        type="button"
                                        className={`relative flex gap-3.5 text-left bg-white border rounded-2xl p-4 sm:p-3 lg:p-6 cursor-pointer transition-all overflow-hidden w-full font-sans ${isActive
                    ...
                    <div
                        className="w-full relative lg:min-h-[580px] bg-gradient-to-br from-forest to-forest-deep border border-[rgba(239,159,39,0.2)] rounded-2xl overflow-hidden"
                        onMouseEnter={() => setIsHovering(true)}
                        onMouseLeave={() => setIsHovering(false)}
                    >
                        {tabs.map((tab, idx) => {

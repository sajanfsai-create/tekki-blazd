      ...
      <div className="wrap max-w-[1240px]">
        <div className="text-center max-w-[720px] mx-auto mb-12">
          <Reveal delay={0}>
            ...
            <h2 className="font-inter font-black tracking-tight text-[32px] sm:text-[46px] leading-tight text-ink">
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="bg-white rounded-[14px] p-5 border border-[rgba(29,158,117,0.12)] border-t-[3px] border-t-amber-brand shadow-[0_4px_24px_rgba(4,52,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-[12.5px] text-text-soft leading-relaxed">CPU ops/sec, disk IOPS, memory latency & boot time — measured, not guessed.</p>
              </div>
              ...
              <div className="bg-white rounded-[14px] p-5 border border-[rgba(29,158,117,0.12)] border-t-[3px] border-t-amber-brand shadow-[0_4px_24px_rgba(4,52,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-[12.5px] text-text-soft leading-relaxed">Can it run your tools? 10 software categories matched to your exact specs.</p>
              </div>
              ...
              <div className="bg-white rounded-[14px] p-5 border border-[rgba(29,158,117,0.12)] border-t-[3px] border-t-amber-brand shadow-[0_4px_24px_rgba(4,52,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-[12.5px] text-text-soft leading-relaxed">Reclaim gigabytes of junk safely — free, optional, and always asks first.</p>
              </div>
              ...
              <div className="bg-white rounded-[14px] p-5 border border-[rgba(29,158,117,0.12)] border-t-[3px] border-t-amber-brand shadow-[0_4px_24px_rgba(4,52,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-[12.5px] text-text-soft leading-relaxed">Exact part recommendations, exact prices — know the cost before any shop visit.</p>
              </div>
              ...
              <div className="bg-white rounded-[14px] p-5 border border-[rgba(29,158,117,0.12)] border-t-[3px] border-t-amber-brand shadow-[0_4px_24px_rgba(4,52,44,0.04)] hover:-translate-y-1 transition-transform duration-300">
                ...
                <p className="text-[12.5px] text-text-soft leading-relaxed">Every component's serial fingerprinted — any hardware change is flagged on re-scan.</p>
              </div>
            </div>
          </div>
        </Reveal>

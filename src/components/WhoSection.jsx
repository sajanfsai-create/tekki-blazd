export default function WhoSection() {
  const cards = [
    ...
    },
    {
      ...
      desc: "Hand every customer a professional health report in 3 minutes — and spend your time fixing, not guessing. Bulk scan pricing available.",
      ...
      <div className="wrap">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4.5 items-stretch">
          {cards.map(c => (
            <div
              key={c.badge}
              className={`relative rounded-2xl p-[30px] px-6 bg-white flex flex-col transition-all duration-200 hover:-translate-y-1 ${
                c.highlight
